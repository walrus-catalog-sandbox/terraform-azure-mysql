...
```
infrastructure:
  resource_group: string             # the resource group name where to deploy the MySQL Flexible Server
  virtual_network: string            # the virtual network name where to deploy the MySQL Flexible Server
  subnet: string                     # the subnet name under the virtual network where to deploy the MySQL Flexible Server
